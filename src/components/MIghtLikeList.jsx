  ...
  return (
    <div className="pt-[20px] px-[15px] bg-[#F7F9F9] rounded-[10px]">
        ...
        <div className="flex items-center">
          ...
          <button className='p-3 text-white font-bold text-[18px] leading-[18px] bg-black rounded-[50px]'>Follow</button>
        </div>
        <div className="flex items-center mt-[25px]">
          <img src={Human2} alt="human img" width={60} height={60} />
          <div className="ml-[13px] mr-[65px]">
